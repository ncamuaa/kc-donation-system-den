...
export function Navbar({ onToggleSidebar }) {
  ...
  const visibleAlerts = useMemo(
    () => dueAlerts.filter((d) => !dismissedIds.has(d.id)),
  ...
  const typeBadgeColor = (type) => (
    { Donor: 'bg-blue-100 text-blue-700', Donation: 'bg-green-100 text-green-700', Project: 'bg-purple-100 text-purple-700' }[type] || 'bg-gray-100 text-gray-700'
  );
